...
oCMenu.barcolor="#33ffcc" //The color of the background bar - Value: "color"
...
oCMenu.level[0].bgcoloroff="#33ffcc" //The default background color for each level[0] (top) items. You can override this on each item by spesifying the backgroundcolor when making the item. - Value: "color"
...
oCMenu.level[0].hovercolor="#99ff33" //The default "on" text color for each level[0] (top) items. You can override this on each item by spesifying the "on" text color when making the item. - Value: "color"
oCMenu.level[0].style="padding-top:2px; font-family:Lucida Handwriting,arial,helvetica; font-size:13px;" //The style for all level[0] (top) items. - Value: "style_settings"
...
oCMenu.level[0].NS4font="Lucida Handwriting,arial,helvetica"
...
oCMenu.level[1].style="padding-top:2px; font-family:Lucida Handwriting, arial,helvetica; font-size:11px;"
...
oCMenu.level[2].style="padding:2px; font-family:Lucida Handwriting,arial,helvetica; font-size:10px; font-weight:bold"
oCMenu.level[2].align="bottom"
oCMenu.level[2].offsetX=0
oCMenu.level[2].offsetY=0
oCMenu.level[2].border=0
oCMenu.level[2].bordercolor="#006699"
oCMenu.level[2].NS4font="Lucida Handwriting,arial,helvetica"
